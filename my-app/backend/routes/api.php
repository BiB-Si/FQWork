...
use App\Http\Controllers\HardwareReportController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/hwinfo/upload', [HardwareReportController::class, 'upload']);
    // Получить список отчётов (можно фильтровать по build_id)
    Route::get('/hwinfo/reports', [HardwareReportController::class, 'index']);
    // Получить конкретный отчёт по id
    Route::get('/hwinfo/reports/{id}', [HardwareReportController::class, 'show']);
